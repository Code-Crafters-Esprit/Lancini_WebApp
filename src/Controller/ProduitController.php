...
class ProduitController extends AbstractController
{
    ...
    public function addStudentJSON(Request $req,UserRepository $ur, NormalizerInterface $Normalizer)
    {
        ...
        $produit->setVendeur($ur->find($req->get('vendeur')));
        $em->persist($produit);
        $em->flush();
   ...
   #[Route('/admin', name: 'app_produit_index', methods: ['GET'])]
