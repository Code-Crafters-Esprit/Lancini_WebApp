 ...
 */
final class Version20230406002437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement CHANGE userId userid INT DEFAULT NULL, CHANGE userIdFollowed useridFollowed INT DEFAULT NULL');
        $this->addSql('DROP INDEX userid ON abonnement');
        $this->addSql('CREATE INDEX IDX_351268BBF132696E ON abonnement (userid)');
        $this->addSql('DROP INDEX useridfollowed ON abonnement');
        $this->addSql('CREATE INDEX IDX_351268BB53DDBAB5 ON abonnement (useridFollowed)');
        ...
        $this->addSql('ALTER TABLE administrateur CHANGE idUser idUser INT DEFAULT NULL');
        $this->addSql('DROP INDEX iduser ON administrateur');
        $this->addSql('CREATE INDEX IDX_32EB52E8FE6E88D7 ON administrateur (idUser)');
        ...
        $this->addSql('ALTER TABLE avis ADD id_avis VARCHAR(255) NOT NULL, DROP id, CHANGE description description VARCHAR(100) NOT NULL, CHANGE note note VARCHAR(255) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_avis)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD CONSTRAINT question_ibfk_1 FOREIGN KEY (testId) REFERENCES test (idTest)');
        ...
        $this->addSql('ALTER TABLE abonnement CHANGE userid userId INT NOT NULL, CHANGE useridFollowed userIdFollowed INT NOT NULL');
        $this->addSql('DROP INDEX idx_351268bb53ddbab5 ON abonnement');
        $this->addSql('CREATE INDEX userIdFollowed ON abonnement (userIdFollowed)');
        $this->addSql('DROP INDEX idx_351268bbf132696e ON abonnement');
        $this->addSql('CREATE INDEX userId ON abonnement (userId)');
        ...
        $this->addSql('ALTER TABLE administrateur CHANGE idUser idUser INT NOT NULL');
        $this->addSql('DROP INDEX idx_32eb52e8fe6e88d7 ON administrateur');
        $this->addSql('CREATE INDEX idUser ON administrateur (idUser)');
        ...
        $this->addSql('ALTER TABLE avis ADD id INT AUTO_INCREMENT NOT NULL, DROP id_avis, CHANGE description description TEXT NOT NULL, CHANGE note note INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
